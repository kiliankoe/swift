...
public func run_Dictionary(scale: Int) {
  let Input = [
    ...
    "choosing", "a", "good", "hash", "function",
      ...
      "application", "in", "particular", "falls", "one", "uses", "dynamic",
      ...
      "may", "cause", "the", "lookup", "cost", "to", "skyrocket", "even", "falls",
      ...
      "masking", "they", "may", "also", "be", "appropriate", "falls", "there",
    ...
    "perfect", "hash", "function",
      "falls", "all", "keys", "are", "known", "ahead", "of", "time", "a",
      "perfect", "hash", "function", "can", "be", "used", "to", "create", "a",
      "perfect", "hash", "table", "that", "has", "no", "collisions", "falls",
